...
resource "aws_security_group" "bastion_ssh_all_sg_assessment" {
    
    name            = "bastion_ssh_all_sg_assessment"
    description     = "Allow SSH from Anywhere"
    vpc_id          = aws_vpc.vpcassessment.id #module.site.output_vpc_id 
    ...
    Name            = "Bastion Allow All_assessment"
    }
...
output "output_bastion_ssh" {
  value = aws_security_group.bastion_ssh_all_sg_assessment.id
}
...
resource "aws_security_group" "bastion_ssh_from_nat" {
    ...
    ingress {
     ...
     protocol        = "tcp"
     security_groups = [
                        aws_security_group.bastion_ssh_all_sg_assessment.id,
...
resource "aws_security_group" "internal_alb_sg" {
    ...
    ingress {
        ...
        to_port     = 3000
        protocol    = "tcp"
        cidr_blocks = [var.app_private_subnet_1]
    }
      ...
      ingress {
        ...
        to_port     = 3000
        protocol    = "tcp"
        cidr_blocks = [var.app_private_subnet_2]
    }
...
resource "aws_security_group" "web_from_nat_prv_sg" {
    ...
    ingress {
        ...
        to_port         = 80
        protocol        = "tcp"
        cidr_blocks     = [aws_subnet.web_private_subnet1.cidr_block]
    }
    ...
    ingress {
       ...
       ingress {
        ...
        to_port         = 80
        protocol        = "tcp"
        cidr_blocks     = [aws_subnet.web_private_subnet2.cidr_block]
    }
    ...
    ingress {
        ...
        to_port         = 80
        protocol        = "tcp"
        cidr_blocks     = [aws_subnet.app_private_subnet1.cidr_block]
    }
    ...
    ingress {
       ...
       ingress {
        ...
        to_port         = 80
        protocol        = "tcp"
        cidr_blocks     = [aws_subnet.app_private_subnet2.cidr_block]
    }
...
resource "aws_security_group" "databasesg" {
    ...
    vpc_id                  = aws_vpc.vpcassessment.id
     ...
     ingress {
        ...
        to_port         = 3306
        protocol        = "tcp"
        cidr_blocks     = [aws_subnet.db_private_subnet1.cidr_block]
    }
    ...
    ingress {
      ...
      ingress {
        ...
        to_port         = 3306
        protocol        = "tcp"
        cidr_blocks     = [aws_subnet.db_private_subnet2.cidr_block]
    }
